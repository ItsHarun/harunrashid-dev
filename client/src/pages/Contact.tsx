        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4 pt-8">
            ...
            <ul className="space-y-2 font-mono text-sm">
              <li>
                <a href="mailto:hello@kue.com" className="hover:text-muted-foreground transition-colors duration-400">
                  hello@kue.com
                </a>
              </li>
              <li>
                <a href="#" className="hover:text-muted-foreground transition-colors duration-400">
                  @harun on X
                </a>
              </li>
            </ul>
